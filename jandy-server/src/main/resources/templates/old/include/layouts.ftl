  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="navbar-nav nav navbar-right">
        <#if self??>
          <li class="dropdown">
            <a href="#" style="padding-top: 0;" class="navbar-brand" data-toggle="dropdown" aria-haspopup="true"
               aria-expanded="false">
            ...
            <#--<div style="display:inline-block; background-image: url('${user.avatarUrl}'); background-size: cover; width: 30px; height: 30px; padding-top: -10px; border-radius: 5px;">&nbsp;</div>-->
              <img src="${self.avatarUrl}" style="display: inline-block; background-size: cover; border-radius: 5px;"
